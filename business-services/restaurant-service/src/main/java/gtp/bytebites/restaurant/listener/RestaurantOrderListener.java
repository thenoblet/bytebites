package gtp.bytebites.restaurant.listener;
...
public class RestaurantOrderListener {
    private static final Logger log = LoggerFactory.getLogger(RestaurantOrderListener.class);
    ...
    private void processOrderEvent(OrderPlacedEvent event) {
        log.info("Restaurant service received order: {}", event);
    }
}